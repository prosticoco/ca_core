...
if __name__ == '__main__':
	...
	parser.add_argument('--ip',default='10.0.0.3',help='server ip')
	...
	parser.add_argument('--cert',default='keys/ca-core-cert.pem',help='server certificate path')
	parser.add_argument('--sk',default='keys/ca-core-key.pem',help='server private key path')
